...
void CoupleScenario::marryAll(Room *room) const{
    foreach (const QString &husband_name, husband_map.keys()) {
        ...
        if (!wife_names.isEmpty()) {
            foreach (const QString &wife_name, wife_names) {
