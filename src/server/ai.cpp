...
AI::Relation AI::GetRelationHegemony(const ServerPlayer *a, const ServerPlayer *b) {
    QStringList aBasaraGenerals = a->getBasaraGeneralNames();
    QStringList bBasaraGenerals = b->getBasaraGeneralNames();
    const bool aShown = aBasaraGenerals.isEmpty();
    const bool bShown = bBasaraGenerals.isEmpty();

    const QString aName = aShown ? a->getGeneralName() : aBasaraGenerals.first();
    const QString bName = bShown ? b->getGeneralName() : bBasaraGenerals.first();
