...
public:
    explicit GeneralOverview(QWidget *parent = 0);
    ~GeneralOverview();
...
private:
    ...
    QString getCurrentSelectedGeneralName() const;
    const General *getCurrentSelectedGeneral() const;
    void updateChangeGeneralButtonState();
    QString getCurrentSelectedGeneralHeroSkinName() const;
    void addLinesHelper(const QString &skillName, const QStringList &aduioSources,
